...
urlpatterns = [
    ...
    path('grafico_stock', views.grafico_stock, name='grafico_stock'),
    path('grafico_sales', views.grafico_sales, name='grafico_sales'),
    path('grafico_pais', views.grafico_pais, name='grafico_pais'),
